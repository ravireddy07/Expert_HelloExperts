...
def searchFrom(maze, startRow , startColumn):
    ...
    if maze[startRow][startColumn] == OBSTACLE:  # we have run into an obstacle, return false
        return False


    if maze[startRow][startColumn] == TRIED:     # we have found a square that has already been explored
        return False


    if maze.isExit(startRow, startColumn):      # Success, an outside edge not occupied by an obstacle
